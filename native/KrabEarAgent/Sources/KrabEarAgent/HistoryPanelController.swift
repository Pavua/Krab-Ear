...
final class HistoryPanelController: NSWindowController, NSTableViewDataSource, NSTableViewDelegate, NSWindowDelegate, NSTabViewDelegate {
    ...
    private func setupUI() {
        ...
        NSLayoutConstraint.activate([
            mainTabView.topAnchor.constraint(equalTo: windowContentView.topAnchor, constant: 8),
        ...
        let dictationHistoryPreviewScroll = NSScrollView()
        ...
        let dictationHistoryHeaderRow = NSStackView()
        ...
        NSLayoutConstraint.activate([
            ...
            dictationStack.bottomAnchor.constraint(equalTo: dictationContentView.bottomAnchor, constant: -12),
        ...
        NSLayoutConstraint.activate([
            ...
            liveStack.bottomAnchor.constraint(equalTo: liveContentView.bottomAnchor, constant: -12),
        ...
        NSLayoutConstraint.activate([
            ...
            historyStack.bottomAnchor.constraint(equalTo: historyContentView.bottomAnchor, constant: -12),
    ...
    private func applyHistoryFocusMode(_ enabled: Bool) {
        for row in historyFocusManagedRows {
            row.isHidden = enabled
        }
        // В фокус-режиме таблица получает больше места и её проще читать.
        historyScrollMinHeightConstraint?.constant = enabled ? 360 : 260
