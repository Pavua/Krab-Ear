...
class BackendService:
    ...
    def handle_request(self, payload: dict[str, Any]) -> dict[str, Any]:
        ...
        handlers: dict[str, Callable[[dict[str, Any]], dict[str, Any]]] = {
            ...
            "export_glossary_csv": self._glossary_svc.handle_export_glossary_csv,  # экспорт глоссария в CSV-строку
            "import_glossary_csv": self._glossary_svc.handle_import_glossary_csv,  # импорт CSV в translation_glossary (merge|replace)
