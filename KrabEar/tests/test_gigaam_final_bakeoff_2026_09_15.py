...
PHRASES = (
    ("long", "Здравствуйте, это проверка связи. Неплохо работает быстрый "
    ...
    ("medium", "Неплохо работает быстрый транспорт, слова появляются "
               "практически сразу. Позвоните завтра после обеда.",
     ("неплохо", "транспорт", "позвоните")),
    ("short", "Неплохо работает быстрый транспорт.",
     ("неплохо", "транспорт")),
)
