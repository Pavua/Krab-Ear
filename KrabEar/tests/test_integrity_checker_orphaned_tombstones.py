...
class TestIntegrityCheckerOrphanedTombstones(unittest.TestCase):
    def setUp(self):
        ...
        self.history_path.write_text(
            json.dumps({"id": "item1", "ts": "2026-01-01T00:00:00Z", "text": "foo"}) + "\n"
        )

        # tombstones has item2 (meaning item2 was deleted)
        self.tombstones_path.write_text(
            json.dumps({"id": "item2", "ts": "2026-01-01T00:00:00Z", "text": "deleted"}) + "\n"
        )
