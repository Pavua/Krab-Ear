...
# Private _handle_* methods that appear directly in the dispatch table
_HANDLE_METHODS = [
    "_handle_ping", "_handle_start_recording", "_handle_stop_recording",
    "_handle_get_recording_state", "_handle_list_audio_inputs",
    "_handle_transcribe_paths", "_handle_transcribe_paths_async",
    "_handle_get_transcribe_progress", "_handle_cancel_transcribe_job",
    "_handle_preview_transcribe_paths", "_handle_get_diagnostics",
    "_handle_get_metrics_dashboard", "_handle_extract_action_items",
    "_handle_batch_extract_action_items", "_handle_get_pending_action_items",
    "_handle_configure_auto_export", "_handle_health_check",
    "_handle_report_paste_failure", "_handle_report_hotkey_conflict",
    "_handle_handshake", "_handle_report_reconnect",
    "_handle_list_recent_errors", "_handle_clear_recent_errors",
    "_handle_handle_error_action", "_handle_probe_llm_http",
    "_handle_warmup_rewriter", "_handle_send_diagnostics_to_sentry",
    "_handle_get_memory_stats", "_handle_get_usage_stats",
    "_handle_get_system_info", "_handle_find_duplicates",
    "_handle_get_keyword_cloud", "_handle_compare_recordings",
    "_handle_get_smart_vocabulary_suggestions",
    "_handle_get_startup_diagnostics", "_handle_get_shutdown_status",
    "_handle_check_duplicate", "_handle_run_deduplication",
    "_handle_get_dedup_stats", "_handle_get_timeline_view",
    "_handle_get_recent_searches", "_handle_get_popular_searches",
    "_handle_clear_search_history",
    "_handle_generate_stats_report", "_handle_generate_mini_stats_report",
    "_handle_generate_daily_digest", "_handle_compare_periods",
    "_handle_get_activity_calendar", "_handle_get_recording_insights",
    "_handle_get_sentiment_trends", "_handle_check_integrity",
    "_handle_repair_integrity", "_handle_extract_terms",
    "_handle_get_context_memory", "_handle_score_transcription",
    "_handle_generate_auto_title", "_handle_get_learning_stats",
    "_handle_get_analytics_dashboard", "_handle_get_topic_timeline",
    "_handle_estimate_recording_cost", "_handle_get_daily_cost_summary",
    ...
    "_handle_create_calendar_event", "_handle_send_imessage",
    "_handle_list_telegram_chats", "_handle_batch",
