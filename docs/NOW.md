...
Последствие: SSE-события не доезжают до REST-процесса, то есть живые панели встречи и быстрой заметки не получают партиалы. Диктовка и хоткеи не затронуты. Волна не начата — решение владельца.
